...
- 🌅 Щоденне ранкове повідомлення о 00:00 з інформацією про планові відключення.
...
2. Активуйте workflows натиснувши **"I understand my workflows, go ahead and enable them"** (якщо потрібно).
3. Знайдіть та відкрийте workflow з назвою **"Run power outages monitor"** для тестового запуску.
4. Праворуч вгорі натисніть **Run workflow** → і ще раз на **Run workflow** всередині випадного меню.

**Примітка:** Автоматично запускаються два workflows:
- **Run power outages monitor** - кожні 10 хвилин перевіряє відключення
- **Daily morning summary** - щодня о 00:00 за київським часом надсилає ранкове повідомлення
...
```bash
# Перевірка відключень (основний моніторинг)
node monitor.js

# Ранкове повідомлення (виконується автоматично о 00:00)
...
### Повідомлення про виявлення відключення
...
### Ранкове повідомлення (о 00:00)

**При наявності планових відключень:**
```
🌅 Доброго ранку!

📋 Інформація про відключення на сьогодні:
...
**При відсутності планових відключень:**
```
🌅 Доброго ранку!
